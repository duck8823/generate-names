...
public class GenerateNamesProcessor extends AbstractProcessor {
	...
	public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
		...
		for(final Element element : elements){
			...
			builder.addMethods(findFields(element, element.getAnnotation(GenerateNames.class)));
	 ...
	 * @param element クラス要素
	 */
	private Set<MethodSpec> findFields(Element element, GenerateNames generateNames) {
		return findFields(element, generateNames, new HashSet<>());
	}
	 ...
	 */
	private Set<MethodSpec> findFields(Element element, GenerateNames generateNames, HashSet<String> contains) {
		...
		if(generateNames.findSuperclass() && superclassElement != null) {
			methodSpecs.addAll(findFields(superclassElement, generateNames, contains));
		}
		return methodSpecs;
	}
}
