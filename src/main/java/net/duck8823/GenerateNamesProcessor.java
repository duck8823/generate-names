...
public class GenerateNamesProcessor extends AbstractProcessor {
	...
	public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
		...
		for(final Element element : elements){
			...
			builder.addFields(findFields(element));
	...
	/**
	 * {@link Element}内のフィールドを取得する
	 * @param element クラス要素
	 */
	private Set<FieldSpec> findFields(Element element) {
	 ...
	 */
	private Set<FieldSpec> findFields(Element element, HashSet<String> contains) {
		...
		typeElement.getEnclosedElements().stream().filter(o -> o.getKind().isField()).filter(o -> !contains.contains(o.toString())).forEach( o -> {
			FieldSpec fieldSpec = FieldSpec.builder(String.class, o.toString(), Modifier.PUBLIC, Modifier.FINAL)
		...
		if(superclassElement != null) {
			fieldSpecs.addAll(findFields(superclassElement, contains));
		}
		return fieldSpecs;
	}
}
